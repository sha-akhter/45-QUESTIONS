...
let friendsArr1 = ["Hina", "Bushra", "Asfa", "Naz"];
friendsArr1.forEach(friendsArr1 => console.log(`Hello ${friendsArr1}, How are you?`));
//Question#13
...
let transportationModes = ["bike", "car", "scooty", "Jeeb", "train"];
